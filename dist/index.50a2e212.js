$(document).ready(function() {
    $(document.querySelectorAll(".counter__number")).each(function() {
        ...
        let btnHeight = bgobj.getBoundingClientRect().bottom - bgobj.getBoundingClientRect().top;
        $(window).scroll(function() {
            ...
            if (screenCoords > minCoord && screenCoords < maxCoord) {
                number = MaxBlockValue / (maxCoord - minCoord) * (screenCoords - minCoord);
...
//# sourceMappingURL=index.50a2e212.js.map
