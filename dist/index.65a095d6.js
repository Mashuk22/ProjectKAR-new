!function(t) {
    ...
    return (function t1(e, i1, n) {
        function o(r, a) {
            if (!i1[r]) {
                ...
                e[r][0].call(u.exports, function(t) {
                    var i = e[r][1][t];
                    return o(i || t);
                }, u, u.exports, t1, e, i1, n);
            }
            return i1[r].exports;
        }
        for(var s = "function" == typeof require && undefined, r1 = 0; r1 < n.length; r1++)o(n[r1]);
        return o;
    })({
        1: [
            function(t2, e1, i2) {
                ...
                e1.exports = (function() {
                    try {
                        ...
                        var t3 = "abc";
                        if (t3[5] = "de", "5" === Object.getOwnPropertyNames(t3)[0]) return !1;
                        for(var e = {
                    ...
                    for(var i, a, l = n1(t), h = 1; h < arguments.length; h++){
            ...
            function(t4, e, i3) {
                (function(t5) {
                    (function() {
                        ...
                        } : void 0 !== t5 && null !== t5 && t5.hrtime ? (e.exports = function() {
                            return (i() - r) / 1000000;
                        }, n = t5.hrtime, s = (i = function() {
                            var t;
                            return 1000000000 * (t = n())[0] + t[1];
                        })(), a = 1000000000 * t5.uptime(), r = s - a) : Date.now ? (e.exports = function() {
                            return Date.now() - o;
                        }, o = Date.now()) : (e.exports = function() {
                            return new Date().getTime() - o;
                        }, o = new Date().getTime());
                    }).call(this);
                }).call(this, t4("_process"));
            },
            {
                _process: 3
            }, 
        ...
        4: [
            function(t8, e3, i5) {
                (function(i6) {
                    for(var n = t8("performance-now"), o = "undefined" == typeof window ? i6 : window, s = [
                        "moz",
                        "webkit"
                    ...
                    if (!a || !l) {
                        ...
                        a = function(t9) {
                            if (0 === d.length) {
                                var e4 = n(), i = Math.max(0, 1000 / 60 - (e4 - u));
                                u = i + e4, setTimeout(function() {
                                    var t = d.slice(0);
                                    d.length = 0;
                    ...
                    e3.exports = function(t) {
                        return a.call(o, t);
                    }, e3.exports.cancel = function() {
                        l.apply(o, arguments);
                    }, e3.exports.polyfill = function() {
            ...
            function(t11, e5, i7) {
                ...
                var o1 = function() {
                    ...
                    return function(e, i, n) {
                        return i && t12(e.prototype, i), n && t12(e, n), e;
                    };
                }(), s1 = t11("raf"), r2 = t11("object-assign"), a = {
                    propertyCache: {
                    },
                    vendors: [
                        null,
                    ...
                    function t13(e, i) {
                        ...
                        r2(this, l1, o, i), this.inputElement || (this.inputElement = this.element), this.calibrationTimer = null, this.calibrationFlag = !0, this.enabled = !1, this.depthsX = [], this.depthsY = [], this.raf = null, this.bounds = null, this.elementPositionX = 0, this.elementPositionY = 0, this.elementWidth = 0, this.elementHeight = 0, this.elementCenterX = 0, this.elementCenterY = 0, this.elementRangeX = 0, this.elementRangeY = 0, this.calibrationX = 0, this.calibrationY = 0, this.inputX = 0, this.inputY = 0, this.motionX = 0, this.motionY = 0, this.velocityX = 0, this.velocityY = 0, this.onMouseMove = this.onMouseMove.bind(this), this.onDeviceOrientation = this.onDeviceOrientation.bind(this), this.onDeviceMotion = this.onDeviceMotion.bind(this), this.onOrientationTimer = this.onOrientationTimer.bind(this), this.onMotionTimer = this.onMotionTimer.bind(this), this.onCalibrationTimer = this.onCalibrationTimer.bind(this), this.onAnimationFrame = this.onAnimationFrame.bind(this), this.onWindowResize = this.onWindowResize.bind(this), this.windowWidth = null, this.windowHeight = null, this.windowCenterX = null, this.windowCenterY = null, this.windowRadiusX = null, this.windowRadiusY = null, this.portrait = !1, this.desktop = !navigator.userAgent.match(/(iPhone|iPod|iPad|Android|BlackBerry|BB10|mobi|tablet|opera mini|nexus 7)/i), this.motionSupport = !!window.DeviceMotionEvent && !this.desktop, this.orientationSupport = !!window.DeviceOrientationEvent && !this.desktop, this.orientationStatus = 0, this.motionStatus = 0, this.initialise();
                    }
                    return o1(t13, [
                        {
                            key: "initialise",
...
//# sourceMappingURL=index.65a095d6.js.map
